      ...
      {showImage && imageUrl && (
        <div className='text-center'>
          <img
            ...
            className='mx-auto h-auto max-h-96 max-w-full rounded-lg border border-gray-600'
          />
        </div>
      )}
          ...
          {receiptAnalyze.expenses.map((expense: TExpense, index: number) => (
            ...
            >
              <div className='mb-2 flex items-center justify-between'>
                <span className={`rounded px-2 py-1 text-xs font-semibold text-white ${getCategoryColor(expense.category)}`}>
                  {expense.category}
                </span>
